...
open class PortMapperComparatorExternalPort(ascending: Boolean) :
    PortMapperComparatorBase(ascending) {
    override fun compare(p1: PortMapping, p2: PortMapping): Int {
...
open class PortMapperComparatorInternalPort(ascending: Boolean) :
    PortMapperComparatorBase(ascending) {
    override fun compare(p1: PortMapping, p2: PortMapping): Int {
...
open class PortMapperComparatorExpiration(ascending: Boolean) :
    PortMapperComparatorBase(ascending) {
    override fun compare(p1: PortMapping, p2: PortMapping): Int {
...
open class PortMapperComparatorDescription(ascending: Boolean) :
    PortMapperComparatorBase(ascending) {
    override fun compare(p1: PortMapping, p2: PortMapping): Int {
