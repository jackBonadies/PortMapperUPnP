...
data class PortMappingWithPref(
    val portMapping: PortMapping,
    val portMappingPref: PortMappingPref? = null
) {
...
data class PortMapping(
    ...
    // RemoteHost needs to be * for Verizon Router - CR1000B, but only for delete call (create works fine)
